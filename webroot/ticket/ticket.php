    ...
    <div class="table_centr">
                ...
                <table class="table-1" >
                    ...
                    <tr>
                        <td colspan="2">
                            <p>
                                Данный билет дает право на посещение бизнес
                                форума Ukraine Level Up 2016.<br><br>

                                Билет необходимо распечатать и предьявить на входе<br><br>

                                Данный билет действителен на одного человека.<br><br>

                                После регистрации на входе билет гасится и<br>
                                становиться недействительным!<br><br>

                                Не передавайте уникальный код третьим лицам!<br><br>

                                Электронный билет обмену и возврату не подлежит.<br><br>

                                Киев, Парковая дорога 16а, Конгресс-холл "Парковый".<br>
                                Контактный тел. (044) 338 12 64
                            </p>
                        </td>
                    </tr>
                </table>
